...
const About = () => {
  ...
  return (
   <Container className='mt-4 flex flex-col sm:flex-row-reverse items-center'>
   <div className="sm:self-start w-full max-w-sm bg-lightCream border border-lightGray rounded-lg shadow dark:bg-lightBlue dark:border-medianBlue">
     ...
     <div className="flex flex-col items-center pb-10">
       ...
       <div className="flex mt-4 space-x-3 md:mt-6">
         <a href="https://www.instagram.com/" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-lightCream bg-medianBlue rounded-lg hover:bg-darkBlue focus:ring-4 focus:outline-none focus:ring-medianBlue dark:bg-medianBlue dark:hover:bg-darkBlue dark:focus:ring-darkBlue">Añadir</a>
         <a href="https://lafu.live#contact" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-darkBlue bg-lightCream border border-lightGray rounded-lg hover:bg-lightBlue focus:ring-4 focus:outline-none focus:ring-lightGray dark:bg-darkBlue dark:text-lightCream dark:border-medianBlue dark:hover:bg-medianBlue dark:hover:border-medianBlue dark:focus:ring-medianBlue">Mensaje</a>
       </div>
     </div>
   </div>
   <div className="max-w-sm sm:mr-4 w-full bg-lightCream border border-lightGray rounded-lg shadow dark:bg-lightBlue dark:border-medianBlue mb-4 sm:mt-0 mt-4 sm:mt-auto sm:max-w-max min-h-full">
